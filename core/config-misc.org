...
#+BEGIN_SRC emacs-lisp-example
  ...
  (desktop-save-mode 1)
  ;; 设置 desktop 相关文件的路径
  (setq desktop-base-file-name (locate-user-emacs-file "emacs/desktop" (xdg-cache-home)))
  (setq desktop-base-lock-name (expand-file-name "emacs/desktop.lock" (xdg-cache-home)))
