...
#+BEGIN_SRC emacs-lisp
  (use-package multi-compile
    ...
    (setq multi-compile-alist
          '((c++-mode . (("cpp-solo-compile" . "g++ -Wall %file-name -o %file-sans")
                         ("cpp-solo-run"     . "./%file-sans")
                         ("cpp-solo-clean"   . "rm -f %file-sans %file-sans.exe")
                         ("cpp-make" . "make --no-print-directory -C %make-dir")))
