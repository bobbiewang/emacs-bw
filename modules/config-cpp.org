...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar bw/cpp-completion-backend 'clangd
    "C++ 的补全后端，可选 'irony、'ccls、'clangd。")
...
#+BEGIN_SRC emacs-lisp
  (use-package semantic
    ...
    (setq semanticdb-default-save-directory
          (expand-file-name "emacs/semanticdb" (xdg-cache-home)))
    :config
...
#+BEGIN_SRC emacs-lisp
  (use-package cmake-ide
    ...
    (setq cmake-ide-build-pool-dir (expand-file-name "emacs/cmake-ide"
                                                     (xdg-cache-home)))
...
#+BEGIN_SRC emacs-lisp
  (use-package irony
    ...
    (setq irony-server-install-prefix
          (expand-file-name "emacs/irony" (xdg-cache-home)))
    (setq irony-user-dir
          (expand-file-name "emacs/irony" (xdg-cache-home)))
